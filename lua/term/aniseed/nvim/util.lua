...
local _0_
do
  local name_0_ = "term.aniseed.nvim.util"
  local module_0_
  do
...
local function _2_(...)
  ...
  local function _2_()
    return {autoload("term.aniseed.nvim")}
  end
  ok_3f_0_, val_0_ = pcall(_2_)
  if ok_3f_0_ then
    _0_["aniseed/local-fns"] = {autoload = {nvim = "term.aniseed.nvim"}}
    return val_0_
  else
    return print(val_0_)
  end
...
local _2amodule_name_2a = "term.aniseed.nvim.util"
