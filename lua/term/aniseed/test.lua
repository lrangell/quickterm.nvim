...
local _0_
do
  local name_0_ = "term.aniseed.test"
  local module_0_
  do
...
local function _2_(...)
  ...
  local function _2_()
    return {autoload("term.aniseed.core"), autoload("term.aniseed.fs"), autoload("term.aniseed.nvim"), autoload("term.aniseed.string")}
  end
  ok_3f_0_, val_0_ = pcall(_2_)
  if ok_3f_0_ then
    _0_["aniseed/local-fns"] = {autoload = {a = "term.aniseed.core", fs = "term.aniseed.fs", nvim = "term.aniseed.nvim", str = "term.aniseed.string"}}
    return val_0_
  else
    return print(val_0_)
  end
...
local _2amodule_name_2a = "term.aniseed.test"
