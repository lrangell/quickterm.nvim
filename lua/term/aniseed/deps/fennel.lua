package.preload["term.aniseed.fennel.repl"] = package.preload["term.aniseed.fennel.repl"] or function(...)
  local utils = require("term.aniseed.fennel.utils")
  local parser = require("term.aniseed.fennel.parser")
  local compiler = require("term.aniseed.fennel.compiler")
  local specials = require("term.aniseed.fennel.specials")
...
package.preload["term.aniseed.fennel.view"] = package.preload["term.aniseed.fennel.view"] or function(...)
...
package.preload["term.aniseed.fennel.specials"] = package.preload["term.aniseed.fennel.specials"] or function(...)
  local utils = require("term.aniseed.fennel.utils")
  local view = require("term.aniseed.fennel.view")
  local parser = require("term.aniseed.fennel.parser")
  local compiler = require("term.aniseed.fennel.compiler")
  ...
  local function metadata_only_fennel(modname)
    if ((modname == "term.aniseed.fennel.macros") or (package and package.loaded and ("table" == type(package.loaded[modname])) and (package.loaded[modname].metadata == compiler.metadata))) then
...
package.preload["term.aniseed.fennel.compiler"] = package.preload["term.aniseed.fennel.compiler"] or function(...)
  local utils = require("term.aniseed.fennel.utils")
  local parser = require("term.aniseed.fennel.parser")
  local friend = require("term.aniseed.fennel.friend")
  local unpack = (table.unpack or _G.unpack)
  local scopes = {}
...
package.preload["term.aniseed.fennel.friend"] = package.preload["term.aniseed.fennel.friend"] or function(...)
  local function ast_source(ast)
    local m = getmetatable(ast)
    return ((m and m.line and m) or (("table" == type(ast)) and ast) or {})
  end
...
package.preload["term.aniseed.fennel.parser"] = package.preload["term.aniseed.fennel.parser"] or function(...)
  local utils = require("term.aniseed.fennel.utils")
  local friend = require("term.aniseed.fennel.friend")
  local unpack = (table.unpack or _G.unpack)
...
local utils = nil
package.preload["term.aniseed.fennel.utils"] = package.preload["term.aniseed.fennel.utils"] or function(...)
...
utils = require("term.aniseed.fennel.utils")
local parser = require("term.aniseed.fennel.parser")
local compiler = require("term.aniseed.fennel.compiler")
local specials = require("term.aniseed.fennel.specials")
local repl = require("term.aniseed.fennel.repl")
local view = require("term.aniseed.fennel.view")
...
do
  ...
  local module_name = "term.aniseed.fennel.macros"
  local _ = nil
  local function _0_()
    return mod
  end
